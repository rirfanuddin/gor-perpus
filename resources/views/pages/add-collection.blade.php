...
<nav class="page-breadcrumb">
  <ol class="breadcrumb">
    <li class="breadcrumb-item"><a href="{{ url('home') }}">Home</a></li>
      <li class="breadcrumb-item active" aria-current="page">Tambah Koleksi</li>
  </ol>
</nav>
        ...
        <div class="table-responsive pt-3">
            ...
            <form action="{{ route('storeCollectionDB') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <input type="number" class="form-control" id="exampleInputText1" value="1" placeholder="Jumlah" name="jumlah">
                </div>
                <div class="form-group">
